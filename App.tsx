...
const App: React.FC = () => {
  ...
  const renderQuadrant = (qType: QuadrantType) => {
    ...
    return (
      ...
      >
        <div className={`px-2 sm:px-3 py-1 sm:py-1.5 flex items-center justify-between text-white ${q.color} ${isHovered ? 'brightness-110' : ''}`}>
        ...
        <div className="flex-1 p-1 sm:p-2 lg:p-3 overflow-y-auto custom-scrollbar bg-white/30 backdrop-blur-[2px]">
  ...
  return (
    <div className="h-screen flex flex-col bg-[#f8fafc]">
      ...
      <main className="flex-1 flex flex-col p-0.5 overflow-hidden">
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 grid-rows-[repeat(4,minmax(150px,1fr))] md:grid-rows-2 gap-0.5 h-full">
          {renderQuadrant('DO')}
